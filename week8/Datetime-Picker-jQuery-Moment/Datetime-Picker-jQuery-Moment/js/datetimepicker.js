        ...
        return this.each(function () {
            ...
            elem.on('click', function () {
                ...
                function changeDate() {
                    ...
                    $div.unbind('click');
                     console.log("DateFormat: ",selectDate.format('DD-MM-YYYY'));
                ...
                function close() {
                    if (settings.showTime) {
                        ...
                        console.log("check:", lastSelected.hour(parseInt($hour.text())))
                ...
                function updateMainElem() {
                    ...
                    if (settings.showTime) {
                        $s = $('<span>');
                        $s.text(lastSelected.format(arrF[1]));
                        console.log("testtttttt: ",lastSelected.format(arrF[1]));
                        elem.append($s);
                        $s = $('<i>');
                        $s.addClass('fa fa-clock-o ico-size');
                        elem.append($s);
