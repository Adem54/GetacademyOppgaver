...
//We used arrow functions on all the handle events. This allows us to call them from the view using the this context of the controller. If we did not use arrow functions, we would have to manually bind them, like this.view.bindAddTodo(this.handleAddTodo.bind(this)). Yikes.
      ...
      console.log("constructon thiss: ", this);
...
this.model.bindTodoListChanged(this.onTodoListChanged
 // Now after every method in the model, you'll call the onTodoListChanged callback.
    ...
    handleDeleteTodo(id){
      ...
      //Bu this eger handleDeleteTodo kendine ait thisi var ve controller icinde, view icindeki bir fonksiyon cagirilarak onun icine parametre olarak bu fonksyon veriliyor dolayisi ile de bu fonksiyonu view icindeki baska bir fonksiyon icinde calistirmaya calisyoruz, ama bu fonksiyonun kendisi baska bir fonksiyon icinde calistirilmis idi, ve this olarak bu fonksiyonun Controller class ini tanimasi gerekiyor,yani controller class ini this olarak tnaimasi gerekiyor onun icinde biz ne yapariz handleDeleteTodo fonskiyonunu parametre olarak verdigmiz yerde onu bind ile icinde bulundugu this olan Controller class ina yani constructor fonks una baglayarak sorunu cozeriz.....
